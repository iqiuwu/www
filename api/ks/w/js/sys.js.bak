...
function __x_dl(){//¶ÔÁª
	document.write("<!--¶ÔÁª¹ã¸æ´úÂë-->");
}
function __x_top(){//¶¥²¿¹ã¸æ
	document.write("<!--¶¥²¿¹ã¸æ´úÂë-->");
}
function __x_middle(){//ÖĞ²¿¹ã¸æ
	document.write("<!--ÖĞ²¿¹ã¸æ´úÂë-->");
}
function __x_bottom(){//µ×²¿¹ã¸æ
	document.write("<!--µ×²¿¹ã¸æ´úÂë-->");
}
function __17mb_s1(){//ÄÚÈİÒ³·½ĞÎ¹ã¸æ×ó
	document.write("<!--ÄÚÈİÒ³·½ĞÎ¹ã¸æ×ó-->");
} 
function __17mb_s2(){//ÄÚÈİÒ³·½ĞÎ¹ã¸æÖĞ
	document.write("<!--ÄÚÈİÒ³·½ĞÎ¹ã¸æÖĞ-->");
}
function __17mb_s3(){//ÄÚÈİÒ³·½ĞÎ¹ã¸æÓÒ
	document.write("<!--ÄÚÈİÒ³·½ĞÎ¹ã¸æÓÒ-->");
}
function __17mb_s4(){//ÄÚÈİÒ³·­Ò³ÉÏ
	document.write("<!--ÄÚÈİÒ³·­Ò³ÉÏ-->");
}
function __17mb_s5(){//ÄÚÈİÒ³·­Ò³ÏÂ
	document.write("<!--ÄÚÈİÒ³·­Ò³ÏÂ-->");
}
...
if(jieqiUserId != 0 && jieqiUserName != '' && (document.cookie.indexOf('PHPSESSID') != -1 || jieqiUserPassword != '')){
  document.writeln('<ul><li><a href="/userdetail.php?uid='+jieqiUserId+'" target="_top">'+jieqiUserName+'</a></li><li>µÈ¼¶£º'+jieqiUserGroupName+'</li><li>Í·ÏÎ£º'+jieqiUserHonor+'</li><li><a href="/modules/article/bookcase.php?uid='+jieqiUserId+'" target="_top">ÎÒµÄÊé¼Ü</a></li> ');
  if(jieqiNewMessage > 0){
	document.write('<li><a class="new" href="/message.php?uid='+jieqiUserId+'&box=inbox" target="_top">ÄúÓĞ¶ÌĞÅ</a></li>');
  }else{
	document.write('<li><a href="/message.php?uid='+jieqiUserId+'&box=inbox" target="_top">²é¿´¶ÌĞÅ</a></li>');
  }
  document.write('<li><a href="/userdetail.php?uid='+jieqiUserId+'" target="_top">²é¿´×ÊÁÏ</a></li>');
  document.write('<li><a href="/logout.php" target="_self">ÍË³öµÇÂ¼</a></li>');
  document.write('</ul>');
}else{
  var jumpurl="";
...
document.writeln("<input type=\"text\" class=\"inp\" value=\"ÇëÊäÈëÕÊºÅ\" onFocus=\"this.style.color = \'#000000\';this.focus();if(this.value==\'ÇëÊäÈëÕÊºÅ\'){this.value=\'\';}\" onBlur=\"this.style.color = \'#d5d5d5\';if(this.value==\'\'){this.value=\'ÇëÊäÈëÕÊºÅ\';}\" onDblClick=\"javascript:this.value=\'\'\" name=\"username\" id=\"username\">");
document.writeln("<input type=\"password\" class=\"inp\"  value=\"ÇëÊäÈëÃÜÂë\" onFocus=\"this.style.color = \'#000000\';this.focus();if(this.value==\'ÇëÊäÈëÃÜÂë\'){this.value=\'\';}\" onBlur=\"this.style.color = \'#d5d5d5\';if(this.value==\'\'){this.value=\'ÇëÊäÈëÃÜÂë\';}\" onDblClick=\"javascript:this.value=\'\'\" name=\"password\" id=\"password\">");
document.writeln("<input class=\"int\" type=\"submit\" value=\"µÇÂ½\"><a href=\"/getpass.php\" title=\"Íü¼ÇÃÜÂë\">Íü¼ÇÃÜÂë</a> | <a href=\"/register.php\" title=\"ÓÃ»§×¢²á\">ÓÃ»§×¢²á</a></form>");
}
}
    ...
    try{
        ...
        if(window.netscape){
            try{
                ...
                alert("±§Ç¸£¬´Ë²Ù×÷±»ä¯ÀÀÆ÷¾Ü¾ø£¡\n\nÇëÔÚä¯ÀÀÆ÷µØÖ·À¸ÊäÈë¡°about:config¡±²¢»Ø³µÈ»ºó½«[signed.applets.codebase_principal_support]ÉèÖÃÎª'true'");
            }
        }else{
...
document.writeln("<input name=\"searchkey\" type=\"text\" id=\"searchkey\" class=\"input\" onfocus=\"if (value ==\'ÇëÊäÈëĞ¡ËµÃû»ò×÷ÕßÀ´ËÑË÷£¬Ç§Íò±ğÊä´í×Ö£¡\'){value =\'\';style.color=\'#000\'}\" onBlur=\"if (value ==\'\'){value=\'ÇëÊäÈëĞ¡ËµÃû»ò×÷ÕßÀ´ËÑË÷£¬Ç§Íò±ğÊä´í×Ö£¡\';style.color=\'#000\'}\" value=\"ÇëÊäÈëĞ¡ËµÃû»ò×÷ÕßÀ´ËÑË÷£¬Ç§Íò±ğÊä´í×Ö£¡\">");
document.writeln("<input type=\"submit\"  value=\"ËÑË÷\" class=\"btn_search\">");
...
var st = function(){
        ...
        stTransform(!t);
        document.getElementById("st").innerHTML = t?"·±ówÖĞÎÄ":"¼òÌåÖĞÎÄ";
}

window.onload = function(){
        if(Cookie.Get("l") == "t")
                setTimeout(function(){stTransform(true);document.getElementById("st").innerHTML = "¼òÌåÖĞÎÄ";},100);
}
...
function gotop(){var scrolltotop={
	setting:{
		startline:300, //ÆğÊ¼ĞĞ
		scrollto:0, //¹ö¶¯µ½Ö¸¶¨Î»ÖÃ
		scrollduration:400, //¹ö¶¯¹ı¶ÉÊ±¼ä
		fadeduration:[500,100] //µ­³öµ­ÏÖÏûÊ§
	},
	controlHTML:'<img src="/qqtxt/css/images/top.gif" style="width:40px; height:40px; border:0;" />', //·µ»Ø¶¥²¿°´Å¥
	controlattrs:{offsetx:30,offsety:80},//·µ»Ø°´Å¥¹Ì¶¨Î»ÖÃ
	anchorkeyword:"#top",
	state:{
		isvisible:false,
		shouldvisible:false
